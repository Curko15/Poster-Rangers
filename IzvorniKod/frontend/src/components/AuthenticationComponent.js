...
const AuthenticationComponent = ({ viewType }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                console.log(`${viewType === 'login' ? 'Login' : 'Registration'} successful`);
            } else {
                console.log(`${viewType === 'login' ? 'Login' : 'Registration'} failed`);
            }
        } catch (error) {
            console.error(`Error during ${viewType === 'login' ? 'login' : 'registration'}:`, error);
        }
    };
