\chapter{Opis projektnog zadatka}
		...
		Superadministrator je osoba koja može stvarati druge administratore koji onda mogu stvarati konferencije i zaduženi su za proces prijave odnosno takav administrator prijavljuje autore i njihove radove nakon što mu autori koji sudjeluju na stručnoj konferenciji elektroničkom poštom pošalju sve potrebne materijale te bira fotografije koje će biti dostupne za pregledavanje i preuzimanje na aplikaciji i postavlja promotivne materijale. Sistemski administrator definira sve potrebne parametre za rad sustava te su mu dostupne sve potrebne informacije o konferenciji. Superadministrator i drugi administratori prijavljuju se u sustav na početnoj stranici web-aplikacije te su im gore navedene funkcionalnosti ovisno o njihovoj ulozi dostupne nakon prijave u sustav.\\
