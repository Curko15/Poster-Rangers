\chapter{Arhitektura i dizajn sustava}
	...
	\end{itemize}
			...
			\subsection{Opis tablica}
				...
				{Glasanje - entitet Glasanje služi za prebrojavanje broja glasova postera te također služi za prevenciju glasovanja jednog registriranog korisnika za više postera. Atributi koje sadrži entitet Glasanje su: posterID koji je jedinstveni identifikator postera te je također i primarni ključ, konfID koji je jedinstveni identifikator konferencije te je također i strani ključ email koji je adresa elektroničke pošte korisnika, ali je isto tako i strani ključ}
