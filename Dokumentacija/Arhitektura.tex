\chapter{Arhitektura i dizajn sustava}
	...
	\end{itemize}
		...
		Zbog lakše organizacije projekta, svi kontroler razredi koji su zaduženi za upravljanje endpoint-ima su svrstani u paket \textit{ src/main/java/opp/rest}. Kontroleri igraju ključnu ulogu u upravljanju HTTP zahtjevima, te su odgovorni za primanje zahtjeva od klijenta, obradu tih zahtjeva i generiranje odgovora. U našoj implementaciji imamo više kontrolera kako bi lakše organizirali i razdvojili sve dostupne endpoint-e. Npr. razred KonferencijaController je zadužen za obradu zahtjeva poput stvaranja konferencija, ulaska u konferenciju i dohvaćanja osnovnih informacija o konferenciji.
